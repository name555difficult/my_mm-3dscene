    ...
    def __init__(
        ...
        if split == "all":
            ...
            split_filenames = os.path.join(
                data_root, "meta_data", "scannetv2_{}.txt".format(split)
            )
    ...
    def __getitem__(self, idx):
        ...
        if self.split == "train":
            ...
            if Croped_scene[0].shape[0] < 512:
                org_coord_1, org_feat_1, org_label_1, GT_feat_1 = (
                    org_coord,
                    org_feat,
                    org_label,
                    GT_feat,
...
if __name__ == "__main__":
    ...
    point_data = ScanNet(
        split="train", data_root=data_root, num_point=8192, transform=None
    )
    ...
    for idx in range(2):
        ...
        for i, (org_points, org_labels, partial_points, partial_labels) in enumerate(
            train_loader
        ):
